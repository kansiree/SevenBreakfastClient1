...
package th.co.gosoft.android.framework.lib.zxing.maxicode;
...
import th.co.gosoft.android.framework.lib.zxing.maxicode.decoder.Decoder;
...
public final class MaxiCodeReader implements Reader {
   ...
   * case.
   *
   * @see th.co.gosoft.android.framework.lib.zxing.pdf417.PDF417Reader#extractPureBits(BitMatrix)
   * @see th.co.gosoft.android.framework.lib.zxing.datamatrix.DataMatrixReader#extractPureBits(BitMatrix)
   * @see th.co.gosoft.android.framework.lib.zxing.qrcode.QRCodeReader#extractPureBits(BitMatrix)
   */
