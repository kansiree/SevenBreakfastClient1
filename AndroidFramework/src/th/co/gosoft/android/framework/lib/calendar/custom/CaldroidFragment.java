...
public class CaldroidFragment extends DialogFragment {
	...
	public int getBackgroundResourceForDate(Date date) {
		DateTime dateTime = CalendarHelper.convertDateToDateTime(date);
		if(!backgroundForDateTimeMap.containsKey(date))return -1;
	...
	public int getTextColorForDate(Date date) {
		DateTime dateTime = CalendarHelper.convertDateToDateTime(date);
		if(!textColorForDateTimeMap.containsKey(dateTime))return -1;
		return textColorForDateTimeMap.get(dateTime);
	}
