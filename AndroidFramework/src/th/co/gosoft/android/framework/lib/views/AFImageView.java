...
public class AFImageView extends ImageView implements View.OnTouchListener {
	...
	public AFImageView(Context context, AttributeSet attr) {
		super(context, attr);
		...
		mDetector = new GestureDetector(mContext,
				new GestureDetector.SimpleOnGestureListener() {
					...
					public boolean onSingleTapConfirmed(MotionEvent e) {
						...
						if (getMyOnClickListerner() != null) {

							getMyOnClickListerner().onClick(AFImageView.this);
	...
	public View.OnClickListener getMyOnClickListerner() {
		return myOnClickListerner;
	}

	public void setMyOnClickListerner(View.OnClickListener myOnClickListerner) {
		this.myOnClickListerner = myOnClickListerner;
	}
